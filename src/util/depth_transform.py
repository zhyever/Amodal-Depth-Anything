...
def get_depth_normalizer(cfg_normalizer):
    ...
    elif 'sam_depth' == cfg_normalizer.type:
        depth_transform = SAMNormalizer()
    else:
...
class SAMNormalizer(DepthNormalizerBase):
    """
        The pesudo label on SAM is in the range of [0 - 1].
        This normalizer is used to convert the depth from [0 - 1] to [-1, 1]
    """
