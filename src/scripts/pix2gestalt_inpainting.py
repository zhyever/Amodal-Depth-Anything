...
if __name__ == "__main__":
    ...
    combined_depth = '/ibex/ai/home/liz0l/codes/depth-fm/data/sam/pix2gestalt_occlusions_release/depth_da_update_combine' # gt
    object_depth = '/ibex/ai/home/liz0l/codes/depth-fm/data/sam/pix2gestalt_occlusions_release/depth_da_update_occ'
    ...
    output_path = './work_dir/project_folder/cvpr_baseline/cvpr_base_pix2gestalt_results_update'
    ...
    for image_file in tqdm(valid_samples):
        ...
        amodal_mask = torch.tensor(amodal_mask) > 0
